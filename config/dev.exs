...
config :Tasker, TaskerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "VbUhU73XTN5QmIKLNDngWrVHS1JZ0ETY3LOdsioeHw1ItrhNIE5gHopPd9o2mRDE",
  watchers: [
...
config :logger, :console, 
  ...
  level: :debug # pour que IO.puts écrive en console avec iex -S mix phx.server
